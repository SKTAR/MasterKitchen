...
import { TabSelected } from '../../../restaurant/menulist/menulist.component';
import { MenuService } from '../../../shared/kitchen-services/menu.service';
import { RadlistviewMenuService } from '../../../shared/ui-services/radlistview-menu-service/radlistview-menu.service';
  ...
  constructor(private menuService: MenuService,
    ...
    public selectCategory(index: number) {
     ...
     public listAllCategory() {
       this.menuService.list().pipe(map((response) =>  {
